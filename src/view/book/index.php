<?php include '../partials/_header.php' ?>
    ...
    ?>
    <main class="relative top-16 z-[10] px-0 md:px-3 py-4 flex flex-col md:flex-row justify-center items-start gap-4">
        <img class="min-h-[30rem] shadow-xl rounded-lg" src="../../../public/images/buku/<?=$f['image'] > 0 ? $f['image'] : 'notfound.jpeg' ?>" alt="">
